...
fun IU(miViewModel: MyViewModel) {
    ...
    {
        // Cuadro de texto de cuenta atrás
        if (estadoActual == Estados.ADIVINANDO) {
            //Defino el tamaño de la letra a 40 y antes de el numero, printeo "Tiempo:" .
            Text(
...
fun Boton(miViewModel: MyViewModel, enum_color: Colores) {
    ...
    Button(
        ...
        onClick = {
            ...
            miViewModel.comprobarCorrecto(enum_color.ordinal, enum_color)
        },
        modifier = Modifier
            .size((80).dp, (40).dp)
    ) {
